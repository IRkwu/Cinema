...
class Ui_P1Funcion3(object):
    def setupUi(self, P1Funcion3):
        P1Funcion3.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion3)
        ...
        P1Funcion3.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion3)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion3.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F3
        ventasTotalesP1F3=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion3):
        P1Funcion3.setWindowTitle("Wall-E  - Funcion 3 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion3 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion3()
    ui.setupUi(P1Funcion3)
    P1Funcion3.show()
    sys.exit(app.exec_())
