...
class Ui_P1Funcion4(object):
    def setupUi(self, P1Funcion4):
        P1Funcion4.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion4)
        ...
        P1Funcion4.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion4)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion4.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F4
        ventasTotalesP1F4=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion4):
        P1Funcion4.setWindowTitle("Wall-E  - Funcion 4 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion4 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion4()
    ui.setupUi(P1Funcion4)
    P1Funcion4.show()
    sys.exit(app.exec_())
