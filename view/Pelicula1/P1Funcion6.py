...
class Ui_P1Funcion6(object):
    def setupUi(self, P1Funcion6):
        P1Funcion6.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion6)
        ...
        P1Funcion6.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion6)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion6.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F6
        ventasTotalesP1F6=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion6):
        P1Funcion6.setWindowTitle("Wall-E  - Funcion 6 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion6 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion6()
    ui.setupUi(P1Funcion6)
    P1Funcion6.show()
    sys.exit(app.exec_())
