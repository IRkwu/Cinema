...
class Ui_P1Funcion5(object):
    def setupUi(self, P1Funcion5):
        P1Funcion5.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion5)
        ...
        P1Funcion5.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion5)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion5.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F5
        ventasTotalesP1F5=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion5):
        P1Funcion5.setWindowTitle("Wall-E  - Funcion 5 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion5 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion5()
    ui.setupUi(P1Funcion5)
    P1Funcion5.show()
    sys.exit(app.exec_())
