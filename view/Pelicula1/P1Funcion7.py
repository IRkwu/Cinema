...
class Ui_P1Funcion7(object):
    def setupUi(self, P1Funcion7):
        P1Funcion7.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion7)
        ...
        P1Funcion7.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion7)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion7.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F7
        ventasTotalesP1F7=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion7):
        P1Funcion7.setWindowTitle("Wall-E  - Funcion 7 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion7 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion7()
    ui.setupUi(P1Funcion7)
    P1Funcion7.show()
    sys.exit(app.exec_())
