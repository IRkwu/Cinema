...
class Ui_P1Funcion2(object):
    def setupUi(self, P1Funcion2):
        P1Funcion2.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion2)
        ...
        P1Funcion2.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion2)        
        ...
        self.BotonVolver.clicked.connect(P1Funcion2.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F2
        ventasTotalesP1F2=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion2):
        P1Funcion2.setWindowTitle("Wall-E  - Funcion 2 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion2 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion2()
    ui.setupUi(P1Funcion2)
    P1Funcion2.show()
    sys.exit(app.exec_())
