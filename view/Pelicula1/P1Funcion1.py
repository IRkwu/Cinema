...
class Ui_P1Funcion1(object):
    def setupUi(self, P1Funcion1):
        P1Funcion1.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P1Funcion1)
        ...
        # Crear una lista de las letras para usar en el nombre de los QCheckBox
        letras = ["A", "B", "C", "D", "E"]
        
        # Crear una lista de los números para usar en el nombre de los QCheckBox
        numeros = ["1", "2", "3", "4", "5"]
        
        # Crear y agregar los QCheckBox al layout utilizando bucles for
        for i in range(len(letras)):
            for j in range(len(numeros)):
                checkbox = QtWidgets.QCheckBox(self.gridLayoutWidget)
                self.gridLayout.addWidget(checkbox, j+1, i+1, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
                setattr(self, f"{letras[i]}{numeros[j]}", checkbox)
        ...
        P1Funcion1.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P1Funcion1)    
        ...
        self.BotonVolver.clicked.connect(P1Funcion1.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP1F1
        ventasTotalesP1F1=boletos_vendidos*3000
    ...
    def definirTextos(self, P1Funcion1):
        P1Funcion1.setWindowTitle("Wall-E - Funcion 1 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P1Funcion1 = QtWidgets.QMainWindow()
    ui = Ui_P1Funcion1()
    ui.setupUi(P1Funcion1)
    P1Funcion1.show()
    sys.exit(app.exec_())
