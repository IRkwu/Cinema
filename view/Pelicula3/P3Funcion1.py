...
class Ui_P3Funcion1(object):
    def setupUi(self, P3Funcion1):
        P3Funcion1.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion1)
        ...
        P3Funcion1.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion1)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion1.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F1
        ventasTotalesP3F1=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion1):
        P3Funcion1.setWindowTitle("UP - Funcion 1 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion1 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion1()
    ui.setupUi(P3Funcion1)
    P3Funcion1.show()
    sys.exit(app.exec_())
