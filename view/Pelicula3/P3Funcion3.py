...
class Ui_P3Funcion3(object):
    def setupUi(self, P3Funcion3):
        P3Funcion3.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion3)
        ...
        P3Funcion3.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion3)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion3.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F3
        ventasTotalesP3F3=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion3):
        P3Funcion3.setWindowTitle("UP - Funcion 3 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion3 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion3()
    ui.setupUi(P3Funcion3)
    P3Funcion3.show()
    sys.exit(app.exec_())
