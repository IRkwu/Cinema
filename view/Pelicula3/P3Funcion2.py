...
class Ui_P3Funcion2(object):
    def setupUi(self, P3Funcion2):
        P3Funcion2.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion2)
        ...
        P3Funcion2.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion2)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion2.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F2
        ventasTotalesP3F2=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion2):
        P3Funcion2.setWindowTitle("UP - Funcion 2 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion2 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion2()
    ui.setupUi(P3Funcion2)
    P3Funcion2.show()
    sys.exit(app.exec_())
