...
class Ui_P3Funcion5(object):
    def setupUi(self, P3Funcion5):
        P3Funcion5.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion5)
        ...
        P3Funcion5.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion5)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion5.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F5
        ventasTotalesP3F5=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion5):
        P3Funcion5.setWindowTitle("UP - Funcion 5 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion5 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion5()
    ui.setupUi(P3Funcion5)
    P3Funcion5.show()
    sys.exit(app.exec_())
