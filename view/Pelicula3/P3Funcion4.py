...
class Ui_P3Funcion4(object):
    def setupUi(self, P3Funcion4):
        P3Funcion4.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion4)
        ...
        P3Funcion4.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion4)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion4.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F4
        ventasTotalesP3F4=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion4):
        P3Funcion4.setWindowTitle("UP - Funcion 4 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion4 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion4()
    ui.setupUi(P3Funcion4)
    P3Funcion4.show()
    sys.exit(app.exec_())
