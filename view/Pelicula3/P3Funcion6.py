...
class Ui_P3Funcion6(object):
    def setupUi(self, P3Funcion6):
        P3Funcion6.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P3Funcion6)
        ...
        P3Funcion6.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P3Funcion6)        
        ...
        self.BotonVolver.clicked.connect(P3Funcion6.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP3F6
        ventasTotalesP3F6=boletos_vendidos*3000
    ...
    def definirTextos(self, P3Funcion6):
        P3Funcion6.setWindowTitle("UP - Funcion 6 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P3Funcion6 = QtWidgets.QMainWindow()
    ui = Ui_P3Funcion6()
    ui.setupUi(P3Funcion6)
    P3Funcion6.show()
    sys.exit(app.exec_())
