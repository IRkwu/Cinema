...
class Ui_P2Funcion3(object):
    def setupUi(self, P2Funcion3):
        P2Funcion3.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P2Funcion3)
        ...
        P2Funcion3.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P2Funcion3)        
        ...
        self.BotonVolver.clicked.connect(P2Funcion3.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP2F3
        ventasTotalesP2F3=boletos_vendidos*3000
    ...
    def definirTextos(self, P2Funcion3):
        P2Funcion3.setWindowTitle("Cars - Funcion 3 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P2Funcion3 = QtWidgets.QMainWindow()
    ui = Ui_P2Funcion3()
    ui.setupUi(P2Funcion3)
    P2Funcion3.show()
    sys.exit(app.exec_())
