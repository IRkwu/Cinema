...
class Ui_P2Funcion5(object):
    def setupUi(self, P2Funcion5):
        P2Funcion5.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P2Funcion5)
        ...
        P2Funcion5.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P2Funcion5)        
        ...
        self.BotonVolver.clicked.connect(P2Funcion5.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP2F5
        ventasTotalesP2F5=boletos_vendidos*3000
    ...
    def definirTextos(self, P2Funcion5):
        P2Funcion5.setWindowTitle("Cars - Funcion 5 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P2Funcion5 = QtWidgets.QMainWindow()
    ui = Ui_P2Funcion5()
    ui.setupUi(P2Funcion5)
    P2Funcion5.show()
    sys.exit(app.exec_())
