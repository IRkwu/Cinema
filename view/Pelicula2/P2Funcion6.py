...
class Ui_P2Funcion6(object):
    def setupUi(self, P2Funcion6):
        P2Funcion6.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P2Funcion6)
        ...
        P2Funcion6.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P2Funcion6)        
        ...
        self.BotonVolver.clicked.connect(P2Funcion6.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP2F6
        ventasTotalesP2F6=boletos_vendidos*3000
    ...
    def definirTextos(self, P2Funcion6):
        P2Funcion6.setWindowTitle("Cars - Funcion 6 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P2Funcion6 = QtWidgets.QMainWindow()
    ui = Ui_P2Funcion6()
    ui.setupUi(P2Funcion6)
    P2Funcion6.show()
    sys.exit(app.exec_())
