...
class Ui_P2Funcion4(object):
    def setupUi(self, P2Funcion4):
        P2Funcion4.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P2Funcion4)
        ...
        P2Funcion4.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P2Funcion4)        
        ...
        self.BotonVolver.clicked.connect(P2Funcion4.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP2F4
        ventasTotalesP2F4=boletos_vendidos*3000
    ...
    def definirTextos(self, P2Funcion4):
        P2Funcion4.setWindowTitle("Cars - Funcion 4 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P2Funcion4 = QtWidgets.QMainWindow()
    ui = Ui_P2Funcion4()
    ui.setupUi(P2Funcion4)
    P2Funcion4.show()
    sys.exit(app.exec_())
