...
class Ui_P2Funcion1(object):
    def setupUi(self, P2Funcion1):
        P2Funcion1.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(P2Funcion1)
        ...
        P2Funcion1.setCentralWidget(self.centralwidget)
        

        self.definirTextos(P2Funcion1)        
        ...
        self.BotonVolver.clicked.connect(P2Funcion1.close) #Boton para cerrar la ventana
    ...
    def actualizarVentas(self):
        global ventasTotalesP2F1
        ventasTotalesP2F1=boletos_vendidos*3000
    ...
    def definirTextos(self, P2Funcion1):
        P2Funcion1.setWindowTitle("Cars - Funcion 1 - Cinema PM")
...
if __name__ == "__main__":
    ...
    P2Funcion1 = QtWidgets.QMainWindow()
    ui = Ui_P2Funcion1()
    ui.setupUi(P2Funcion1)
    P2Funcion1.show()
    sys.exit(app.exec_())
